...
public class VENTANADESAYUNO extends JFrame {
    private MAIN main;

    public VENTANADESAYUNO(MAIN main) {
        this.main = main;
        setTitle("Menú - Desayuno");
        setSize(300, 200);
        ...
        String producto1 = "Huevos Rancheros";
        double precio1 = 50.00;

        String producto2 = "Hotcakes";
        double precio2 = 40.00;
