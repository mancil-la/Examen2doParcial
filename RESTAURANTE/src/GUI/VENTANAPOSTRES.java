...
public class VENTANAPOSTRES extends JFrame {
    ...
    public VENTANAPOSTRES(MAIN main) {
        this.main = main;
        setTitle("Menú - Postres");
        setSize(300, 200);
        ...
        String producto1 = "Pastel de Chocolate";
        double precio1 = 45.00;

        String producto2 = "Helado de Vainilla";
        double precio2 = 35.00;
